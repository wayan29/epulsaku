...
export default function DigitalServicesPage() {
  ...
  const handleMobileLegendsNicknameInquiry = async () => {
    ...
    setMlInquiryResult(null);
    try {
      const result = await inquireMobileLegendsNickname({ userId: customerNo, zoneId });
  ...
  const handleGenshinImpactNicknameInquiry = async () => {
    ...
    setGiInquiryResult(null);
    try {
      const result = await inquireGenshinImpactNickname({ userId: customerNo, zoneId: zoneId as typeof genshinImpactServers[number] });
  ...
  const handleHonkaiStarRailNicknameInquiry = async () => {
    ...
    setHsrInquiryResult(null);
    try {
      const result = await inquireHonkaiStarRailNickname({ userId: customerNo, region: zoneId as HonkaiStarRailRegion });
