...
import { Loader2, Save, ShieldAlert, KeyRound, Smartphone, Globe, Settings, ShoppingCart, Lock, Send as SendIcon, UserCircle2 } from "lucide-react"; 
...
const adminSettingsFormSchema = z.object({
  ...
  telegramChatId: z.string().optional(), // Still a string, but UI will instruct for comma separation
    ...
    <div className="space-y-8 max-w-2xl mx-auto">
      <Card className="shadow-xl">
        <CardHeader>
          ...
          <PageCardDescription>
            Manage application credentials and webhook configurations. Password confirmation is required to save any changes.
          </PageCardDescription>
        </CardHeader>
        <CardContent>
          <Card className="border-destructive/50 bg-destructive/5 mb-6">
            <CardContent className="p-4 text-destructive text-sm flex items-start gap-2">
              <ShieldAlert className="h-5 w-5 mt-0.5 flex-shrink-0" />
              <div>
                <strong className="font-semibold">Security Note:</strong> These settings are critical. Ensure accuracy and confirm with your admin password.
              </div>
            </CardContent>
          </Card>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="password" placeholder="Your Digiflazz API Key" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="password" placeholder="Your Digiflazz Webhook Secret Key" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="password" placeholder="Your TokoVoucher Signature" {...field} />
                        </FormControl>
                   ...
                   <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="password" placeholder="Your TokoVoucher API Key/Secret" {...field} />
                        </FormControl>
