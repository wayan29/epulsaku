...
export async function POST(request: NextRequest) {
  try {
    ...
    const updateResult = await updateTransactionInDB({
      ...
      // costPrice will be updated if the webhook provides a definitive price and it's different, handled by updateTransactionInDB logic
      // sellingPrice is usually not updated by webhook as it's our system's price.
    });
