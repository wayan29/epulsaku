...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const updateResult = await updateTransactionInDB({
      ...
      // costPrice might be updated if payload.price is present and different. updateTransactionInDB logic handles this if costPrice is passed.
      // If payload.price exists, pass it to updateTransactionInDB.
